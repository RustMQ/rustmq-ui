                ...
                <form ref={form => this.form = form} onSubmit={this.handleSubmit}>
                    ...
                    <div className="new-message-form__modal__controls">
                        ...
                        <div className="new-message-form__modal__control">
                            ...
                            <input className="new-message-form__modal__control__input" placeholder="60 sec by default" id="timeout" name="timeout" type="text" />
                        </div>
                        <div className="new-message-form__modal__control">
                            <label className="new-message-form__modal__control__label" htmlFor="delay">Delay</label>
                            <input className="new-message-form__modal__control__input" placeholder="0 sec by default" id="delay" name="delay" type="text" />
                        </div>
                        <div className="new-message-form__modal__control">
                            <label className="new-message-form__modal__control__label" htmlFor="expiration">Expiration</label>
                            <input className="new-message-form__modal__control__input" placeholder="604,800 sec (7 days) by default" id="expiration" name="expiration" type="text" />
                        </div>
                    </div>
